...
/**
 * Builds a simple HTML confirmation page displaying a message. This page is
 * typically used after successful or failed actions such as adding, editing, or
...
public class ConfirmationPageBuilder extends PageBuilder {
	...
	/**
	 * Constructs a ConfirmationPageBuilder with the provided message and status.
	 *
	 * @param message      The message to display to the user
	 * @param returnTo     The page to return to
	...
	public String buildPage() {
		...
		html.append("<!DOCTYPE html><html lang='en'><head>")
				...
				.append("</head><body>").append("<div class='header'><div class='header-content'>").append("<a href='")
				.append(returnTo).append("' class='back-btn'>&larr; Back to List</a>").append("</div></div>")
